...
// Set the desired coordinate reference system and scale of the image.
.reproject('EPSG:4326', null, 10000);

// Display the image on the map.
Map.centerObject(fc, 8);
Map.addLayer(
    image, {min: 0, max: 2000, palette: ['ffffb2', 'fd8d3c', 'bd0026']},
    'Mean estimated annual electricity generation, 2015');
